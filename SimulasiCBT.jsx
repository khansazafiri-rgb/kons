              ...
              {visibleSubjects.map((s) => {
                ...
                return (
                  <button
                    ...
                    className={`text-left rounded-xl border p-4 transition-all ${active ? 'border-maroon-600 bg-maroon-50' : 'border-alba-200 hover:border-maroon-200 hover:bg-alba-100/60'
                      }`}
                  >
                ...
                {years.map((y) => {
                  ...
                  return (
                    <button
                      ...
                      className={`relative rounded-xl border px-2 py-2.5 text-sm font-bold transition-all ${year === String(y)
          ...
          <div>
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              <button
                ...
                className={`rounded-xl border-2 p-5 text-left transition-all ${mode === 'simulasi'
              ...
              <button
                ...
                className={`rounded-xl border-2 p-5 text-left transition-all ${mode === 'learning'
                    ? 'border-maroon-600 bg-maroon-50'
                    : 'border-alba-200 hover:border-maroon-200 hover:bg-alba-100/60'
                  }`}
              >
            ...
            <div className="space-y-1.5">
              {leaderboard.map((row, i) => {
                ...
                return (
                  <div
                    key={row.id}
                    className={`flex items-center justify-between rounded-xl px-4 py-2.5 text-sm ${isMe ? 'bg-maroon-50 border border-maroon-100 font-bold text-maroon-700' : 'bg-alba-100/60 text-stone-700'
                      }`}
                  >
                    <span className="flex items-center gap-3">
                      <span className={`w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold ${i === 0 ? 'bg-gold-400 text-alba-50' : i < 3 ? 'bg-gold-100 text-gold-600 border border-gold-200' : 'bg-alba-200 text-stone-500'
                        }`}>{i + 1}</span>
