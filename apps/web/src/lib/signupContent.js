...
export const SIGNUP_TEXT_GROUPS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'labelUserId', label: 'Label ID User', type: 'text', default: 'ID User' },
      { key: 'placeholderUserId', label: 'Placeholder ID User', type: 'text', default: 'ID unik untuk login (mis. namamu123)' },
      ...
      { key: 'labelEmail', label: 'Label Email', type: 'text', default: 'Gmail' },
      { key: 'placeholderEmail', label: 'Placeholder Email', type: 'text', default: 'emailmu@gmail.com' },
      { key: 'hintEmail', label: 'Keterangan kecil di bawah Email', type: 'text', default: 'Notifikasi ACC akan dikirim ke email ini.' },
      ...
      { key: 'placeholderAsalKuliah', label: 'Placeholder Asal Kuliah', type: 'text', default: 'mis. FK UNAIR' },
    ],
  },
  {
